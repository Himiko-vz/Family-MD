...
module.exports = {
    async handler(chatUpdate) {
        ...
        //global.author = 'kevinafsar'
        global.wm2 = global.data.namabot + ' ' + global.data.owner
        global.wm = namabot + 'Kevin afsar'
        global.colong1 = 'Ciss 📸'
        global.colong2 = 'ʙy Kevin afsar'
        global.kontak2 = [
        ['6282132156123', 'Kevin afsar', 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'kevinaafsar@gmail.com', true],
        ['6282132156123', await this.getName('6282132156123@s.whatsapp.net'), 'ᴄꜱ HIMIKO-ʙᴏᴛ', 'kevinaafsar@gmail.com', true],
        ['6283802905703', '𝙴𝙽𝙹𝙴𝙻𝙰-𝙱𝙾𝚃', 'Bot WhatsApp', 'Nothing!', true],
        ['6282132156123', await this.getName('6282132156123@s.whatsapp.net'), 'ᴄꜱ HIMIKO-ʙᴏᴛ', 'kevinaafsar@gmail.com', true],
        ['6282132156123', await this.getName('6282132156123@s.whatsapp.net'), 'ᴄꜱ HIMIKO-ʙᴏᴛ', 'kevinaafsar@gmail.com', true],
        ]
